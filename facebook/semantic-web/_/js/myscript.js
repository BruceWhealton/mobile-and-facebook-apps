window.fbAsyncInit = function() {
	FB.init({
		appId      : '186615101475910', // App ID
		channelUrl : '//my-family-lineage.com/mobile-and-facebook/facebook/semantic-web/channel.php', // Channel File
	...
	FB.getLoginStatus(function(response) {
		if (response.status === 'connected') {
			...
			//User is logged into Facebook, but not your App
			  ...
			  oauth_url += '?client_id=186615101475910'; //Your Client ID
			  oauth_url += '&redirect_uri=' + 'https://apps.facebook.com/com-resources-sw'; //Send them here if they're not logged in
