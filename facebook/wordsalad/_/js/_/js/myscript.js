window.fbAsyncInit = function() {
	FB.init({
		appId      : '427064894002819', // App ID
		channelUrl : '//my-family-lineage.com/channel.php', // Channel File
	...
	FB.getLoginStatus(function(response) {
		if (response.status === 'connected') {
			...
			//User is logged into Facebook, but not your App
			  ...
			  oauth_url += '?client_id=427064894002819'; //Your Client ID
			  oauth_url += '&redirect_uri=' + 'https://apps.facebook.com/my-family-lineage/'; //Send them here if they're not logged in
...
/*$.getJSON('http://blog.my-family-lineage.com/?json=1', function(data) {*/
    var output = '';
    var excerpt='';
...
function postToFeed(myTitle, myLink, myExcerpt) {
	FB.ui({
		method: 'feed',
		'link': myLink,
		'picture': 'http://my-family-lineage.com/facebook/images/LogoMyFamilyLineage.png',
		'name': myTitle,
